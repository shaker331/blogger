...
public function about()
{
  ...
  $tags=Tag::all();
    ...
    $catcount2=$paython->posts()->count();
    $catcount3=$cricket->posts()->count();
    return view('about',compact('setting','cats','posts','tags','catcount','catcount1','catcount2','catcount3'))->with('title','shaker Sports')
    ;
}
public function privacy()
{
  ...
  $tags=Tag::all();
    ...
    $catcount2=$paython->posts()->count();
    $catcount3=$cricket->posts()->count();
    return view('privacy',compact('setting','cats','posts','tags','laravel','catcount','catcount1','catcount2','catcount3','android','paython','cricket'))->with('title','shaker Sports')
    ;
}
...
public function contact()
{
  ...
  $tags=Tag::all();
    ...
    $catcount2=$paython->posts()->count();
    $catcount3=$cricket->posts()->count();
    return view('contact',compact('setting','cats','posts','tags','laravel','catcount','catcount1','catcount2','catcount3','android','paython','cricket'))->with('title','shaker Sports');
}

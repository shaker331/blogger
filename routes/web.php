...
Route::get('/admin/change-password', 'UsersController@changepassword')->name('change_password');
Route::post('/postLogin', 'UsersController@postLogin')->name('postLogin');
Route::post('/Adminlogin', 'UsersController@Adminlogin')->name('Adminlogin');

route::post('/updatenewpassword', 'UsersController@updatenewpwd')->name('update.pwd');
